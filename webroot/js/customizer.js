...
var scene3D;
function startWebGL(jsonbeats_origin) {
...
Scene3D.prototype.getAudio = function () {
	...
	request.open("GET", "/mp3/Jungle by X Ambassadors & Jamie N Commons - Beats by Dre - The Game Before the Game.mp3", true);
...
Scene3D.prototype.addObjectToHeadphone = function ( obj_name, obj_json, obj_shininess, obj_color ) {
	var that = this;
	this.loader.load( '/obj/'+obj_json, function( geometry ) {
...
Scene3D.prototype.changeModel = function ( obj_simple, obj_name ) {
	...
	var that = this;
	this.loader.load( '/obj/'+obj_name, function( geometry ) {
		object = new THREE.Mesh( geometry,
			new THREE.MeshPhongMaterial({
				color: save_color,
				specular: 0x050505,
